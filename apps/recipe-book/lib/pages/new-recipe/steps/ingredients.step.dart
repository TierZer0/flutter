...
class IngredientsStep extends StatelessWidget {
  ...
  IngredientsStep({required this.formGroup, required this.tapForward, required this.tapBack});
      ...
      child: Column(
        children: [
          ...
          ReactiveFormConsumer(builder: (context, form, child) {
            print((form.control('ingredients') as FormGroup).control('items').value.length);
            return Column(
