...
final recipesDataSource = StateProvider((ref) => RecipesDataSource(
    ref: ref, firebaseFirestore: ref.read(firebaseFirestoreProvider)));

final getRecipeProvider =
    FutureProvider.family<FirestoreResult<RecipeModel>, String>(
        (ref, recipeId) {
  return Future.value(ref
      .read(recipesDataSourceProvider.notifier)
      .state
